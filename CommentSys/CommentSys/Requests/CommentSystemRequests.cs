...
namespace CommentSys.Requests
{
    ...
    public class CommentSystemRequests
    {
        ...
        /// </summary>
        /// <returns></returns>
        public IRestResponse GetComment()
        {
            var request = new RestRequest($"/v1/comments/", Method.GET);
