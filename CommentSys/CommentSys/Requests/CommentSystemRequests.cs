...
namespace CommentSys.Requests
{
    ...
    public class CommentSystemRequests
    {
        ...
        * This unfortunately blocked me getting into any further testing with the comment system.
        */
        ...
        public static string xOrgid = "93580465-4d14-4984-8dcd-06326596dcef";
        public static string xProf = string.Empty;
        
        private RestClient client;

        //TODO: Abstract out url to app config
        ...
        /// 
        /// TODO: Breakout for each http verb.
        /// </summary>
        /// <returns></returns>
        public IRestResponse<CommentResponse> GetComment(string commentId = null)
        {
            ...
            if(!string.IsNullOrEmpty(xProf))
            {
                request.AddHeader("X-Profile", xProf);
            }      
    ...
    /// <summary>
    /// Quick model for post comment, not full data model.
    /// </summary>
